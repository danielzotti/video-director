          ...
          @switch (name()) {
              ...
              @case ('magnet') {
                  <g transform="scale(0.75)">
                      <path d="M13.3,7.7l8.1,8.1c1.5,1.5,1.5,3.9,0,5.4c-1.5,1.5-3.9,1.5-5.4,0l-8.1-8.1l-4.7,4.7l8.1,8.1 c4.1,4.1,10.7,4.1,14.8,0s4.1-10.7,0-14.8L18,3L13.3,7.7z"/>
                      <rect x="3.6" y="14.9" transform="matrix(0.7071 -0.7071 0.7071 0.7071 -9.8477 9.8015)" width="6.7" height="3.8"/>
                      <rect x="13.7" y="4.8" transform="matrix(0.7071 -0.7071 0.7071 0.7071 0.2609 13.9887)" width="6.7" height="3.8"/>
                  </g>
              }
              @case ('border') {
